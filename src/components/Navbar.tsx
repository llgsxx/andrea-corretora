...
export const Navbar: React.FC = () => {
    ...
    const waLink = `https://wa.me/${BROKER.whatsappNumber}?text=${encodeURIComponent('Olá! Vim pelo site e gostaria de mais informações.')}`;

    const navLinks = [
        { href: '#sobre', label: 'Sobre' },
        { href: '#servicos', label: 'Serviços' },
        { href: '#credito', label: 'Análise de Crédito' },
    ];
        ...
        <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
            <div className="container navbar__inner">
                ...
                <ul className={`navbar__links ${menuOpen ? 'navbar__links--open' : ''}`}>
                    ...
                    <li>
                        <a href={waLink} target="_blank" rel="noopener noreferrer" className="btn-wa navbar__cta">
